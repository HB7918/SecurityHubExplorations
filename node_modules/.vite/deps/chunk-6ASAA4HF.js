...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/button-dropdown/analytics-metadata/styles.scoped.css";
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/button-dropdown/category-elements/styles.scoped.css";
var styles_css_default2 = {
  "header": "awsui_header_16mm3_1ethj_145",
  "disabled": "awsui_disabled_16mm3_1ethj_161",
  "no-content-styling": "awsui_no-content-styling_16mm3_1ethj_165",
  "expandable-header": "awsui_expandable-header_16mm3_1ethj_171",
  "rolled-down": "awsui_rolled-down_16mm3_1ethj_182",
  "highlighted": "awsui_highlighted_16mm3_1ethj_185",
  "is-focused": "awsui_is-focused_16mm3_1ethj_208",
  "visual-refresh": "awsui_visual-refresh_16mm3_1ethj_211",
  "category": "awsui_category_16mm3_1ethj_215",
  "expandable": "awsui_expandable_16mm3_1ethj_171",
  "variant-navigation": "awsui_variant-navigation_16mm3_1ethj_230",
  "expand-icon": "awsui_expand-icon_16mm3_1ethj_237",
  "expand-icon-up": "awsui_expand-icon-up_16mm3_1ethj_255",
  "expand-icon-right": "awsui_expand-icon-right_16mm3_1ethj_258",
  "items-list-container": "awsui_items-list-container_16mm3_1ethj_266",
  "in-dropdown": "awsui_in-dropdown_16mm3_1ethj_275",
  "icon-wrapper": "awsui_icon-wrapper_16mm3_1ethj_279",
  "header-content": "awsui_header-content_16mm3_1ethj_283"
};

// node_modules/@cloudscape-design/components/button-dropdown/category-elements/category-element.js
var CategoryElement = ({ item, index, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, disabled, variant, position, renderItem }) => {
  var _a;
  ...
  return import_react.default.createElement(
    "li",
    { className: clsx_m_default(styles_css_default2.category, styles_css_default2[`variant-${variant}`], disabled && styles_css_default2.disabled), role: "presentation" },
    item.text && import_react.default.createElement("p", { className: clsx_m_default(styles_css_default2.header, {
      [styles_css_default2.disabled]: disabled,
      [styles_css_default2["no-content-styling"]]: !!renderResult
    }), "aria-hidden": "true" }, renderResult ? renderResult : import_react.default.createElement(
      "span",
      { className: styles_css_default2["header-content"] },
      (item.iconName || item.iconUrl || item.iconSvg) && import_react.default.createElement(
        "span",
        { className: styles_css_default2["icon-wrapper"] },
        import_react.default.createElement(internal_default, { name: item.iconName, url: item.iconUrl, svg: item.iconSvg, alt: item.iconAlt })
      ),
      item.text
    )),
    import_react.default.createElement("ul", { className: styles_css_default2["items-list-container"], role: "group", "aria-label": item.text, "aria-disabled": disabled }, item.items && import_react.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, categoryDisabled: disabled, hasCategoryHeader: !!item.text, variant, position, renderItem, parentProps: groupProps }))
  );
};
...
// node_modules/@cloudscape-design/components/button-dropdown/category-elements/expandable-category-element.js
var ExpandableCategoryElement = ({ index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, disabled, expandToViewport, variant, position, renderItem }) => {
  var _a;
  const highlighted = isHighlighted(item);
  ...
  const renderResult = (_a = renderItem === null || renderItem === void 0 ? void 0 : renderItem({ item: groupProps })) !== null && _a !== void 0 ? _a : null;
  const trigger = item.text && import_react3.default.createElement("span", {
    className: clsx_m_default(styles_css_default2.header, styles_css_default2["expandable-header"], styles_css_default2[`variant-${variant}`], {
      [styles_css_default2.disabled]: disabled,
      [styles_css_default2.highlighted]: highlighted,
      [styles_css_default2["no-content-styling"]]: !!renderResult,
      [styles_css_default2["is-focused"]]: isKeyboardHighlighted,
      [styles_css_default2["visual-refresh"]]: isVisualRefresh
    }),
  ...
  }, renderResult ? renderResult : import_react3.default.createElement(
    import_react3.default.Fragment,
    null,
    (item.iconName || item.iconUrl || item.iconSvg) && import_react3.default.createElement(
      "span",
      { className: styles_css_default2["icon-wrapper"] },
      import_react3.default.createElement(internal_default, { name: item.iconName, url: item.iconUrl, svg: item.iconSvg, alt: item.iconAlt })
    ),
    item.text,
    import_react3.default.createElement(
      "span",
      { className: clsx_m_default(styles_css_default2["expand-icon"], styles_css_default2["expand-icon-right"]) },
  ...
  if (isDisabledWithReason) {
    ...
    content = import_react3.default.createElement(dropdown_default, { open: expanded, interior: true, hideBlockBorder: false, expandToViewport, trigger, content: item.items && expanded ? import_react3.default.createElement(
      "ul",
      { role: "menu", "aria-label": item.text, className: clsx_m_default(styles_css_default2["items-list-container"], styles_css_default2["in-dropdown"]) },
      import_react3.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, variant, position, renderItem, parentProps: groupProps })
    ) : void 0 });
  }
  return import_react3.default.createElement("li", { className: clsx_m_default(styles_css_default2.category, styles_css_default2[`variant-${variant}`], styles_css_default2.expandable, {
    [styles_css_default2.expanded]: expanded,
    [styles_css_default2.disabled]: disabled,
    [styles_css_default2.highlighted]: highlighted
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/button-dropdown/mobile-expandable-group/styles.scoped.css";
...
var MobileExpandableGroup = ({ children, trigger, open }) => {
  return import_react4.default.createElement(
    "div",
    { className: styles_css_default3.root },
    import_react4.default.createElement("div", { className: styles_css_default3.trigger }, trigger),
    import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default3.dropdown, { [styles_css_default3.open]: open }), "data-open": open }, children)
  );
};
var mobile_expandable_group_default = MobileExpandableGroup;

// node_modules/@cloudscape-design/components/button-dropdown/category-elements/mobile-expandable-category-element.js
var MobileExpandableCategoryElement = ({ index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, disabled, variant, position, renderItem }) => {
  var _a;
  const highlighted = isHighlighted(item);
  const expanded = isExpanded(item);
  const isKeyboardHighlighted = isKeyboardHighlight(item);
  ...
  const renderResult = (_a = renderItem === null || renderItem === void 0 ? void 0 : renderItem({ item: groupProps })) !== null && _a !== void 0 ? _a : null;
  const trigger = item.text && import_react5.default.createElement("span", {
    className: clsx_m_default(styles_css_default2.header, styles_css_default2["expandable-header"], styles_css_default2[`variant-${variant}`], {
      [styles_css_default2.highlighted]: highlighted,
      [styles_css_default2["rolled-down"]]: expanded,
      [styles_css_default2["no-content-styling"]]: !!renderResult,
      [styles_css_default2.disabled]: disabled,
      [styles_css_default2["is-focused"]]: isKeyboardHighlighted
    }),
  ...
  }, renderResult ? renderResult : import_react5.default.createElement(
    import_react5.default.Fragment,
    null,
    (item.iconName || item.iconUrl || item.iconSvg) && import_react5.default.createElement(
      "span",
      { className: styles_css_default2["icon-wrapper"] },
      import_react5.default.createElement(internal_default, { name: item.iconName, url: item.iconUrl, svg: item.iconSvg, alt: item.iconAlt })
    ),
    item.text,
    import_react5.default.createElement(
      "span",
      { className: clsx_m_default(styles_css_default2["expand-icon"], {
        [styles_css_default2["expand-icon-up"]]: expanded
      }) },
  ...
  if (isDisabledWithReason) {
    content = import_react5.default.createElement(
      ...
      null,
      descriptionEl,
      import_react5.default.createElement(Tooltip, { content: item.disabledReason }, trigger)
    );
  } else if (disabled) {
    content = trigger;
  } else {
    content = import_react5.default.createElement(mobile_expandable_group_default, { open: expanded, trigger }, item.items && expanded && import_react5.default.createElement(
      "ul",
      { role: "menu", "aria-label": item.text, className: styles_css_default2["items-list-container"] },
      import_react5.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, hasCategoryHeader: true, variant, position, renderItem, parentProps: groupProps })
    ));
  }
  return import_react5.default.createElement("li", { className: clsx_m_default(styles_css_default2.category, styles_css_default2[`variant-${variant}`], styles_css_default2.expandable, {
    [styles_css_default2.expanded]: expanded,
    [styles_css_default2.disabled]: disabled,
    [styles_css_default2.highlighted]: highlighted || expanded,
    [styles_css_default2.expandable]: true
...
// node_modules/@cloudscape-design/components/internal/utils/data-attributes.js
function getDataAttributes(dataAttributes, excludeKeys = []) {
  if (!dataAttributes) {
    return {};
  }
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/button-dropdown/item-element/styles.scoped.css";
var styles_css_default4 = {
  "item-element": "awsui_item-element_93a1u_bdyxn_145",
  "no-content-styling": "awsui_no-content-styling_93a1u_bdyxn_157",
  "disabled": "awsui_disabled_93a1u_bdyxn_162",
  "show-divider": "awsui_show-divider_93a1u_bdyxn_169",
  "highlighted": "awsui_highlighted_93a1u_bdyxn_172",
  "is-focused": "awsui_is-focused_93a1u_bdyxn_187",
  "visual-refresh": "awsui_visual-refresh_93a1u_bdyxn_190",
  "menu-item": "awsui_menu-item_93a1u_bdyxn_194",
  "link-style": "awsui_link-style_93a1u_bdyxn_211",
  "current-breadcrumb": "awsui_current-breadcrumb_93a1u_bdyxn_247",
  "link-style-highlighted": "awsui_link-style-highlighted_93a1u_bdyxn_255",
  "has-category-header": "awsui_has-category-header_93a1u_bdyxn_261",
  "item-tooltip-wrapper": "awsui_item-tooltip-wrapper_93a1u_bdyxn_261",
  "has-checkmark": "awsui_has-checkmark_93a1u_bdyxn_261",
  "icon": "awsui_icon_93a1u_bdyxn_268",
  "checkmark": "awsui_checkmark_93a1u_bdyxn_272",
  "external-icon": "awsui_external-icon_93a1u_bdyxn_279",
  "content-wrapper": "awsui_content-wrapper_93a1u_bdyxn_283",
  "main-row": "awsui_main-row_93a1u_bdyxn_289",
  "label-tag": "awsui_label-tag_93a1u_bdyxn_296",
  "secondary-text": "awsui_secondary-text_93a1u_bdyxn_303"
};

// node_modules/@cloudscape-design/components/button-dropdown/item-element/index.js
var ItemElement = ({ position = "1", index, item, disabled, onItemActivate, highlighted, highlightItem, showDivider, hasCategoryHeader, isKeyboardHighlighted = false, analyticsMetadataTransformer = (metadata) => metadata, variant = "normal", linkStyle, renderItem, parentProps }) => {
  ...
  return import_react6.default.createElement(
    "li",
    { className: clsx_m_default(styles_css_default4["item-element"], styles_css_default4[`variant-${variant}`], {
      [styles_css_default4.highlighted]: highlighted,
      [styles_css_default4.disabled]: disabled,
      [styles_css_default4["has-category-header"]]: hasCategoryHeader,
      [styles_css_default4["has-checkmark"]]: isCheckbox,
      [styles_css_default4["show-divider"]]: showDivider,
      [styles_css_default4["is-focused"]]: isKeyboardHighlighted,
      [styles_css_default4["visual-refresh"]]: isVisualRefresh
    }), role: "presentation", "data-testid": item.id, "data-description": item.description, ...getDataAttributes(item.dataAttributes, ["testid"]), onClick, onMouseEnter: onHover, onTouchStart: onHover, ...getAnalyticsMetadataAttribute(disabled ? {} : analyticsMetadataTransformer({
      action: "click",
      detail: {
        position,
        id: item.id,
        label: `.${styles_css_default["menu-item"]}`,
        href: item.href || ""
      }
    })) },
    import_react6.default.createElement(MenuItem, { index, item, disabled, highlighted, linkStyle, renderItem, parentProps })
  );
};
function MenuItem({ index, item, disabled, highlighted, linkStyle, renderItem, parentProps }) {
  var _a;
  const menuItemRef = (0, import_react6.useRef)(null);
  const isCheckbox = isCheckboxItem(item);
  ...
  const menuItemProps = {
    ...
    className: clsx_m_default(styles_css_default4["menu-item"], !!renderResult && styles_css_default4["no-content-styling"], styles_css_default["menu-item"], linkStyle && styles_css_default4["link-style"], linkStyle && highlighted && styles_css_default4["link-style-highlighted"], isCurrentBreadcrumb && styles_css_default4["current-breadcrumb"]),
  ...
  const menuItem = isLinkItem(item) ? import_react6.default.createElement("a", { ...menuItemProps, href: !disabled ? item.href : void 0, download: !disabled && item.download ? item.download : void 0, target: getItemTarget(item), rel: item.external ? "noopener noreferrer" : void 0 }, renderResult ? renderResult : import_react6.default.createElement(MenuItemContent, { item, disabled, highlighted })) : import_react6.default.createElement("span", { ...menuItemProps }, renderResult ? renderResult : import_react6.default.createElement(MenuItemContent, { item, disabled, highlighted }));
  const { position } = useDropdownContext();
  const tooltipPosition = position === "bottom-left" || position === "top-left" ? "left" : "right";
  return isDisabledWithReason ? import_react6.default.createElement(
    Tooltip,
    { content: item.disabledReason, position: tooltipPosition, className: styles_css_default4["item-tooltip-wrapper"] },
    menuItem,
    descriptionEl
  ) : menuItem;
}
var MenuItemContent = ({ item, disabled, highlighted }) => {
  ...
  return import_react6.default.createElement(
    ...
    null,
    isCheckbox && import_react6.default.createElement(MenuItemCheckmark, { checked: item.checked, disabled }),
    hasIcon && import_react6.default.createElement(MenuItemIcon, { name: item.iconName, url: item.iconUrl, svg: item.iconSvg, alt: item.iconAlt, badge: item.badge }),
    import_react6.default.createElement(
      "div",
      { className: styles_css_default4["content-wrapper"] },
      import_react6.default.createElement(
        "div",
        { className: styles_css_default4["main-row"] },
        import_react6.default.createElement(
          "div",
          null,
          item.text,
          hasExternal && import_react6.default.createElement(ExternalIcon, { disabled, ariaLabel: item.externalIconAriaLabel })
        ),
        item.labelTag && import_react6.default.createElement("div", { className: clsx_m_default(styles_css_default4["label-tag"], disabled && styles_css_default4.disabled) }, item.labelTag)
      ),
      item.secondaryText && import_react6.default.createElement("div", { className: clsx_m_default(styles_css_default4["secondary-text"], highlighted && styles_css_default4.highlighted, disabled && styles_css_default4.disabled) }, item.secondaryText)
    )
  );
};
var MenuItemIcon = (props) => import_react6.default.createElement(
  "span",
  { className: styles_css_default4.icon },
  import_react6.default.createElement(internal_default, { ...props })
);
var MenuItemCheckmark = ({ disabled, checked }) => {
  const checkmark = import_react6.default.createElement(internal_default, { variant: disabled ? "disabled" : "normal", name: "check" });
  return import_react6.default.createElement("span", { className: clsx_m_default(styles_css_default4.icon, styles_css_default4.checkmark, { [styles_css_default4.disabled]: disabled }), "aria-hidden": "true", style: { visibility: checked ? "visible" : "hidden" } }, checkmark);
};
var ExternalIcon = ({ disabled, ariaLabel }) => {
  const icon = import_react6.default.createElement(internal_default, { variant: disabled ? "disabled" : "normal", name: "external" });
  return import_react6.default.createElement("span", { className: styles_css_default4["external-icon"], role: ariaLabel ? "img" : void 0, "aria-label": ariaLabel }, icon);
};
var item_element_default = ItemElement;

// node_modules/@cloudscape-design/components/button-dropdown/items-list.js
function ItemsList({ items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown, highlightItem, categoryDisabled = false, hasExpandableGroups = false, hasCategoryHeader = false, expandToViewport = false, variant = "normal", analyticsMetadataTransformer, position, linkStyle, renderItem, parentProps }) {
  const isMobile = useMobile();
  const elements = items.map((item, index) => {
    var _a, _b, _c, _d;
    if (!isItemGroup(item)) {
      const showDivider = index === items.length - 1 && !lastInDropdown || isItemGroup(items[index + 1]);
      return import_react7.default.createElement(item_element_default, { key: index, index, item, onItemActivate, disabled: (_a = item.disabled) !== null && _a !== void 0 ? _a : categoryDisabled, highlighted: isHighlighted(item), isKeyboardHighlighted: isKeyboardHighlight(item), highlightItem, showDivider, hasCategoryHeader, variant, position: `${position ? `${position},` : ""}${index + 1}`, analyticsMetadataTransformer, linkStyle, renderItem, parentProps });
    }
    if (hasExpandableGroups) {
      return item.text ? isMobile ? import_react7.default.createElement(mobile_expandable_category_element_default, { key: index, index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown: lastInDropdown && index === items.length - 1, highlightItem, disabled: (_b = item.disabled) !== null && _b !== void 0 ? _b : false, variant, position: `${position ? `${position},` : ""}${index + 1}`, renderItem }) : import_react7.default.createElement(expandable_category_element_default, { key: index, index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown: true, highlightItem, disabled: (_c = item.disabled) !== null && _c !== void 0 ? _c : false, expandToViewport, variant, position: `${position ? `${position},` : ""}${index + 1}`, renderItem }) : null;
    }
    return import_react7.default.createElement(category_element_default, { key: index, index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown: lastInDropdown && index === items.length - 1, highlightItem, disabled: (_d = item.disabled) !== null && _d !== void 0 ? _d : false, variant, position: `${position ? `${position},` : ""}${index + 1}`, renderItem });
  });
...
function useHighlightedMenu({ items, hasExpandableGroups, isInRestrictedView = false }) {
  ...
  const moveHighlight2 = (0, import_react8.useCallback)((direction, loop) => {
    const getNext = (index) => {
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/button-dropdown/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/button-dropdown/internal.js
var InternalButtonDropdown = import_react9.default.forwardRef(({ items, variant = "normal", loading = false, loadingText, disabled = false, disabledReason, expandableGroups = false, children, onItemClick, onItemFollow, customTriggerBuilder, expandToViewport, ariaLabel, title, description, preferCenter, mainAction, showMainActionOnly, __internalRootRef, analyticsMetadataTransformer, linkStyle, fullWidth, position, nativeMainActionAttributes, nativeTriggerAttributes, renderItem, ...props }, ref) => {
  var _a;
  ...
  (0, import_react9.useImperativeHandle)(ref, () => ({
    focus(...args) {
      var _a2;
      (_a2 = (hasMainAction ? mainActionRef : triggerRef).current) === null || _a2 === void 0 ? void 0 : _a2.focus(...args);
    },
  ...
  const iconProps = variant === "icon" || variant === "inline-icon" ? {
    ...
    iconAlign: "right",
    __iconClass: spinWhenOpen(styles_css_default5, "rotate", canBeOpened && isOpen)
  };
  const baseTriggerProps = {
    className: clsx_m_default(styles_css_default5["trigger-button"], styles_css_default5["test-utils-button-trigger"], styles_css_default["trigger-label"]),
    ...iconProps,
  ...
  const analyticsMetadata = disabled ? {} : {
    ...
    detail: {
      label: `.${styles_css_default["trigger-label"]}`
    }
  };
  if (customTriggerBuilder) {
    trigger = import_react9.default.createElement("div", { className: styles_css_default5["dropdown-trigger"], ...getAnalyticsMetadataAttribute(analyticsMetadata) }, customTriggerBuilder({
      testUtilsClass: styles_css_default5["test-utils-button-trigger"],
      ariaExpanded: canBeOpened && isOpen,
    ...
    const mainActionAriaLabel = externalIconAriaLabel ? `${(_a = mainAction.ariaLabel) !== null && _a !== void 0 ? _a : mainAction.text} ${mainAction.externalIconAriaLabel}` : mainAction.ariaLabel;
    const hasNoText = !text;
    const mainActionButton = import_react9.default.createElement(InternalButton, { ref: mainActionRef, ...mainActionProps, ...mainActionIconProps, fullWidth: canBeFullWidth, className: clsx_m_default(styles_css_default5["trigger-button"], hasNoText && styles_css_default5["has-no-text"], isVisualRefresh && styles_css_default5["visual-refresh"], canBeFullWidth && styles_css_default5["main-action-full-width"]), variant, ariaLabel: mainActionAriaLabel, formAction: "none", nativeAnchorAttributes: nativeMainActionAttributes === null || nativeMainActionAttributes === void 0 ? void 0 : nativeMainActionAttributes.anchor, nativeButtonAttributes: nativeMainActionAttributes === null || nativeMainActionAttributes === void 0 ? void 0 : nativeMainActionAttributes.button }, text);
    trigger = import_react9.default.createElement(
      "div",
      { role: "group", "aria-label": ariaLabel, className: styles_css_default5["split-trigger-wrapper"] },
      import_react9.default.createElement("div", {
        className: clsx_m_default(styles_css_default5["trigger-item"], styles_css_default5["split-trigger"], styles_css_default5[`variant-${variant}`], mainActionProps.loading && styles_css_default5.loading),
        ...
        ...getAnalyticsMetadataAttribute({
          action: "click",
          detail: {
            label: `.${styles_css_default["main-action-label"]}`
          }
        })
      }, mainActionButton),
      !showMainActionOnly && import_react9.default.createElement(
        "div",
        { className: clsx_m_default(styles_css_default5["trigger-item"], styles_css_default5["dropdown-trigger"], isVisualRefresh && styles_css_default5["visual-refresh"], styles_css_default5[`variant-${variant}`], baseTriggerProps.loading && styles_css_default5.loading), ...getAnalyticsMetadataAttribute(analyticsMetadata) },
        import_react9.default.createElement(InternalButton, { ref: triggerRef, ...baseTriggerProps, className: clsx_m_default(baseTriggerProps.className, {
          [styles_css_default5["main-action-trigger-full-width"]]: canBeFullWidth
    ...
    trigger = import_react9.default.createElement(
      "div",
      { className: styles_css_default5["dropdown-trigger"], ...getAnalyticsMetadataAttribute(analyticsMetadata) },
      import_react9.default.createElement(InternalButton, { ref: triggerRef, id: triggerId, ...baseTriggerProps, className: clsx_m_default(baseTriggerProps.className, {
        [styles_css_default5["full-width"]]: canBeFullWidth,
        [styles_css_default5.loading]: canBeFullWidth && !!loading
  ...
  return import_react9.default.createElement(
    "div",
    { ...baseProps, onKeyDown, onKeyUp, onMouseDown: handleMouseEvent, onMouseMove: handleMouseEvent, className: clsx_m_default(styles_css_default5["button-dropdown"], styles_css_default5[`variant-${variant}`], canBeFullWidth && styles_css_default5["full-width"], baseProps.className), "aria-owns": expandToViewport && isOpen ? dropdownId : void 0, ref: __internalRootRef },
    import_react9.default.createElement(dropdown_default, { open: canBeOpened && isOpen, stretchTriggerHeight: variant === "navigation", minWidth: expandToViewport ? void 0 : "trigger", hideBlockBorder: false, expandToViewport, preferredAlignment: preferCenter ? "center" : "start", onOutsideClick: () => toggleDropdown(), trigger, dropdownId, content: import_react9.default.createElement(
      import_react9.default.Fragment,
      null,
      hasHeader && import_react9.default.createElement(
        "div",
        { className: styles_css_default5.header, id: headerId },
        title && import_react9.default.createElement(
          "div",
          { className: styles_css_default5.title },
        ...
        description && import_react9.default.createElement(
          InternalBox,
          { fontSize: "body-s" },
          import_react9.default.createElement("span", { className: styles_css_default5.description }, description)
        )
      ),
      import_react9.default.createElement(
        ...
        import_react9.default.createElement(ItemsList, { items, onItemActivate, onGroupToggle, hasExpandableGroups: expandableGroups, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, lastInDropdown: true, highlightItem, expandToViewport, variant, analyticsMetadataTransformer, linkStyle, position, renderItem })
      )
    ) })
  );
});
...
export {
  ...
  isLinkItem,
  hasCheckboxItems,
  hasDisabledReasonItems,
  styles_css_default,
  styles_css_default5 as styles_css_default2,
  internal_default2 as internal_default
};
//# sourceMappingURL=chunk-6ASAA4HF.js.map

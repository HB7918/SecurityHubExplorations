...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/space-between/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/space-between/internal.js
var InternalSpaceBetween = (0, import_react.forwardRef)(({ direction = "vertical", size, children, alignItems, nativeAttributes, __internalRootRef, ...props }, ref) => {
  const mergedRef = useMergeRefs(ref, __internalRootRef);
  const baseProps = getBaseProps(props);
  const flattenedChildren = flattenChildren(children);
  return import_react.default.createElement(with_native_attributes_default, { ...baseProps, tag: "div", componentName: "SpaceBetween", nativeAttributes, className: clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default[direction], styles_css_default[`${direction}-${size}`], alignItems && styles_css_default[`align-${alignItems}`]), ref: mergedRef }, flattenedChildren.map((child) => {
    const key = child && typeof child === "object" ? child.key : void 0;
    return import_react.default.createElement("div", { key: key ? String(key) : void 0, className: styles_css_default.child }, child);
  }));
});
...
//# sourceMappingURL=chunk-YR4RWRL4.js.map

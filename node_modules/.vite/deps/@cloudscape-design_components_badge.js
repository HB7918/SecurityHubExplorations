...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/badge/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/badge/index.js
function Badge({ color = "grey", children, style, nativeAttributes, ...rest }) {
  const { __internalRootRef } = useBaseComponent("Badge", { props: { color } });
  const baseProps = getBaseProps(rest);
  const className = clsx_m_default(baseProps.className, styles_css_default.badge, styles_css_default[`badge-color-${color}`]);
  return import_react.default.createElement(with_native_attributes_default, { ...baseProps, tag: "span", componentName: "Badge", nativeAttributes, className, ref: __internalRootRef, style: getBadgeStyles(style) }, children);
}
applyDisplayName(Badge, "Badge");
export {
  Badge as default
};
//# sourceMappingURL=@cloudscape-design_components_badge.js.map

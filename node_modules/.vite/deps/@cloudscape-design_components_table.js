...
} from "./chunk-NUV7WGBD.js";
import {
  InternalFormField
} from "./chunk-D7JY2DSJ.js";
import {
  checkbox_icon_default
} from "./chunk-COYNOBBG.js";
import {
  StatusIndicator
} from "./chunk-EALUKNJJ.js";
import {
  internal_default as internal_default4
} from "./chunk-ZIFNIZ33.js";
import {
  AnalyticsFunnelSubStep,
  InternalContainer
} from "./chunk-SK2ZWU2Z.js";
import {
  styles_css_default as styles_css_default2
} from "./chunk-BHP7WN27.js";
import {
  TableComponentsContextProvider
} from "./chunk-E7JSKTI3.js";
import {
  CollectionLabelContext
} from "./chunk-7ZSCKRXM.js";
import {
  StickyHeaderContext
} from "./chunk-OBXC4LHJ.js";
import {
  useDebounceCallback
} from "./chunk-P4JM5JLK.js";
import "./chunk-QKCYICRE.js";
import {
  useContainerBreakpoints
} from "./chunk-F53DSZQD.js";
import "./chunk-4FS4XO7X.js";
import "./chunk-JB4THFN3.js";
import {
  DragHandleWrapper,
  ScreenreaderOnly,
...
} from "./chunk-PUWRO6IY.js";
import {
  __classPrivateFieldGet,
  __classPrivateFieldSet
} from "./chunk-7JZ5GEGN.js";
import "./chunk-MFH2UGTM.js";
import {
  with_native_attributes_default
} from "./chunk-PJARVU6X.js";
import {
  Portal,
  SYSTEM,
  SelectionTree,
...
function useMouseDownTarget() {
  const mouseDownTargetRef = (0, import_react2.useRef)(null);
...
function useScrollSync(refs) {
  const activeElement = (0, import_react3.useRef)(null);
  return (event) => {
...
function useTableInteractionMetrics({ elementRef, items, itemCount, instanceIdentifier, getComponentIdentifier, getComponentConfiguration, loading = false, interactionMetadata }) {
  ...
  const lastUserAction = (0, import_react4.useRef)(null);
  const capturedUserAction = (0, import_react4.useRef)(null);
  const loadingStartTime = (0, import_react4.useRef)(null);
  const isMountedRef = (0, import_react4.useRef)(true);
  const metadata = (0, import_react4.useRef)({ itemCount, getComponentIdentifier, getComponentConfiguration, interactionMetadata });
...
function useClickAway(onClick) {
  const awayRef = (0, import_react5.useRef)(null);
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/internal/components/expand-toggle-button/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/internal/components/expand-toggle-button/index.js
function ExpandToggleButton({ isExpanded, onExpandableItemToggle, expandButtonLabel, collapseButtonLabel, customIcon, className, disableFocusHighlight }) {
  const buttonRef = (0, import_react6.useRef)(null);
  const { tabIndex } = useSingleTabStopNavigation(buttonRef);
  return import_react6.default.createElement("button", { type: "button", ref: buttonRef, tabIndex, "aria-label": isExpanded ? collapseButtonLabel : expandButtonLabel, "aria-expanded": isExpanded, className: clsx_m_default(styles_css_default3["expand-toggle"], disableFocusHighlight && styles_css_default3["disable-focus-highlight"], className), onClick: onExpandableItemToggle }, customIcon !== null && customIcon !== void 0 ? customIcon : import_react6.default.createElement(internal_default, { size: "small", name: "caret-down-filled", className: clsx_m_default(styles_css_default3["expand-toggle-icon"], isExpanded && styles_css_default3["expand-toggle-icon-expanded"]) }));
}
...
function useStickyColumns({ visibleColumns, stickyColumnsFirst, stickyColumnsLast }) {
  const store = (0, import_react8.useMemo)(() => new StickyColumnsStore(), []);
  const wrapperRef = (0, import_react8.useRef)(null);
  const tableRef = (0, import_react8.useRef)(null);
  const cellsRef = (0, import_react8.useRef)(/* @__PURE__ */ new Map());
  ...
  const setWrapper = (0, import_react8.useCallback)((node) => {
    if (wrapperRef.current) {
  ...
  const setTable = (0, import_react8.useCallback)((node) => {
    tableRef.current = node;
  }, []);
  const setCell = (0, import_react8.useCallback)((columnId, node) => {
    if (node) {
...
function useStickyCellStyles({ stickyColumns, columnId, getClassName }) {
  ...
  const unsubscribeRef = (0, import_react8.useRef)(null);
  const refCallback = (0, import_react8.useCallback)(
    (cellElement) => {
...
function GridNavigationProvider({ keyboardNavigation, pageSize, getTable, children }) {
  const navigationAPI = (0, import_react9.useRef)(null);
  const gridNavigation = (0, import_react10.useMemo)(() => new GridNavigationProcessor(navigationAPI), []);
  ...
  return import_react9.default.createElement(SingleTabStopNavigationProvider, { ref: navigationAPI, navigationActive: keyboardNavigation, getNextFocusTarget: gridNavigation.getNextFocusTarget, isElementSuppressed: gridNavigation.isElementSuppressed, onRegisterFocusable: gridNavigation.onRegisterFocusable, onUnregisterActive: gridNavigation.onUnregisterActive }, children);
}
...
function getVisibleColumnDefinitionsFromColumnDisplay({ columnDisplay, columnDefinitions }) {
  const columnDefinitionsById = columnDefinitions.reduce((accumulator, item) => item.id === void 0 ? accumulator : { ...accumulator, [item.id]: item }, {});
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/table/test-classes/styles.css.js
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/test-classes/styles.scoped.css";
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/body-cell/styles.scoped.css";
...
var TableTdElement = import_react11.default.forwardRef(({ children, wrapLines, isRowHeader, isFirstRow, isLastRow, isSelected, isNextSelected, isPrevSelected, nativeAttributes, onClick, onFocus, onBlur, isEvenRow, stripedRows, isSelection, hasSelection, hasFooter, columnId, colIndex, stickyState, tableRole, level, isExpandable, isExpanded, onExpandableItemToggle, expandButtonLabel, collapseButtonLabel, verticalAlign, resizableColumns, resizableStyle, isEditable, isEditing, isEditingDisabled, hasSuccessIcon, tableVariant, counter, ...rest }, ref) => {
  ...
  const cellRefObject = (0, import_react11.useRef)(null);
  ...
  return import_react11.default.createElement(
    Element,
    { style: { ...resizableStyle, ...stickyStyles.style }, className: clsx_m_default(styles_css_default6["body-cell"], isFirstRow && styles_css_default6["body-cell-first-row"], isLastRow && styles_css_default6["body-cell-last-row"], isSelected && styles_css_default6["body-cell-selected"], isNextSelected && styles_css_default6["body-cell-next-selected"], isPrevSelected && styles_css_default6["body-cell-prev-selected"], !isEvenRow && stripedRows && styles_css_default6["body-cell-shaded"], stripedRows && styles_css_default6["has-striped-rows"], isVisualRefresh && styles_css_default6["is-visual-refresh"], isSelection && styles_css_default4["selection-control"], hasSelection && styles_css_default6["has-selection"], hasFooter && styles_css_default6["has-footer"], resizableColumns && styles_css_default6["resizable-columns"], verticalAlign === "top" && styles_css_default6["body-cell-align-top"], isEditable && styles_css_default6["body-cell-editable"], isEditing && !isEditingDisabled && styles_css_default6["body-cell-edit-active"], isEditing && isEditingDisabled && styles_css_default6["body-cell-edit-disabled-popover"], hasSuccessIcon && styles_css_default6["body-cell-has-success"], level !== void 0 && !isEditingActive && styles_css_default6["body-cell-expandable"], level !== void 0 && !isEditingActive && styles_css_default6[`expandable-level-${getLevelClassSuffix(level)}`], tableVariant && styles_css_default6[`table-variant-${tableVariant}`], stickyStyles.className), onClick, onFocus, onBlur, ref: mergedRef, ...nativeAttributes, tabIndex: cellTabIndex === -1 ? void 0 : cellTabIndex, ...copyAnalyticsMetadataAttribute(rest) },
    level !== void 0 && isExpandable && !isEditingActive && import_react11.default.createElement(
      "div",
      { className: styles_css_default6["expandable-toggle-wrapper"] },
      import_react11.default.createElement(ExpandToggleButton, { isExpanded, onExpandableItemToggle, expandButtonLabel, collapseButtonLabel })
    ),
    import_react11.default.createElement(
      "div",
      { className: clsx_m_default(styles_css_default6["body-cell-content"], wrapLines && styles_css_default6["body-cell-wrap"]) },
      children,
      counter ? import_react11.default.createElement(
        "div",
        { className: styles_css_default6["body-cell-counter"] },
        " ",
        import_react11.default.createElement("span", { className: styles_css_default5["body-cell-counter"] }, counter)
      ) : null
    )
  );
});
...
// node_modules/@cloudscape-design/components/table/body-cell/disabled-inline-editor.js
function DisabledInlineEditor({ item, column, ariaLabels, isEditing, onEditStart, onEditEnd, editDisabledReason, ...rest }) {
  var _a;
  ...
  const iconRef = (0, import_react12.useRef)(null);
  const buttonRef = (0, import_react12.useRef)(null);
  const portalRef = (0, import_react12.useRef)(null);
  ...
  return import_react12.default.createElement(
    TableTdElement,
    { ...rest, nativeAttributes: { "data-inline-editing-active": isEditing.toString() }, isEditing, isEditingDisabled: true, onClick: !isEditing && !isExpandableColumn ? onClick : void 0, ref: !isExpandableColumn ? clickAwayRef : void 0 },
    column.cell(item),
    import_react12.default.createElement(
      ...
      import_react12.default.createElement(
        ...
        import_react12.default.createElement(
          "button",
          { ref: buttonRef, tabIndex, className: clsx_m_default(styles_css_default6["body-cell-editor"], styles_css_default6["body-cell-editor-disabled"], isExpandableColumn && styles_css_default6["body-cell-editor-focusable"]), onClick: !isEditing && isExpandableColumn ? onClick : void 0, "aria-label": (_a = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.activateEditLabel) === null || _a === void 0 ? void 0 : _a.call(ariaLabels, column, item), "aria-haspopup": "dialog", "aria-disabled": "true", onKeyDown: handleEscape, ...targetProps },
          import_react12.default.createElement(
            "span",
            { className: styles_css_default6["body-cell-editor-icon"] },
            import_react12.default.createElement(internal_default, { name: "lock-private", variant: "normal", __internalRootRef: iconRef })
          ),
          descriptionEl
        )
      )
    ),
    isEditing && import_react12.default.createElement(
      "span",
      { ref: portalRef },
      import_react12.default.createElement(
        Portal,
        ...
        import_react12.default.createElement(
          ...
          import_react12.default.createElement(
            PopoverContainer,
            { size: "medium", fixedWidth: false, position: "top", trackRef: iconRef, arrow: (position) => import_react12.default.createElement(arrow_default, { position }), renderWithPortal: true, zIndex: 7e3 },
            import_react12.default.createElement(
              body_default,
              { dismissButton: false, dismissAriaLabel: void 0, header: null, onDismiss: () => {
              }, overflowVisible: "both" },
              import_react12.default.createElement(internal_default2, { tagName: "span" }, editDisabledReason)
            )
          )
        )
      )
...
function InlineEditor({ ariaLabels, item, column, onEditEnd, submitEdit, __onRender }) {
  var _a, _b, _c, _d;
  const [currentEditLoading, setCurrentEditLoading] = (0, import_react13.useState)(false);
  const [currentEditValue, setCurrentEditValue] = (0, import_react13.useState)();
  const i18n = useInternalI18n("table");
  const focusLockRef = (0, import_react13.useRef)(null);
      ...
      import_react13.default.createElement(
        ...
        import_react13.default.createElement(
          ...
          import_react13.default.createElement(
            ...
            import_react13.default.createElement("div", { className: styles_css_default6["body-cell-editor-row-editor"] }, editingCell(item, cellContext)),
            import_react13.default.createElement(
              "span",
              ...
              import_react13.default.createElement(
                ...
                !currentEditLoading ? import_react13.default.createElement(internal_default3, { ariaLabel: (_b = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.cancelEditLabel) === null || _b === void 0 ? void 0 : _b.call(ariaLabels, column), formAction: "none", iconName: "close", variant: "inline-icon", onClick: () => onCancel() }) : null,
                import_react13.default.createElement(internal_default3, { ariaLabel: (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submitEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column), formAction: disableNativeForm ? "none" : "submit", onClick: disableNativeForm ? handleSubmit : void 0, iconName: "check", variant: "inline-icon", loading: currentEditLoading })
              ),
              import_react13.default.createElement(internal_default2, { tagName: "span", hidden: true }, currentEditLoading ? i18n("ariaLabels.submittingEditText", (_d = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submittingEditText) === null || _d === void 0 ? void 0 : _d.call(ariaLabels, column)) : "")
            )
          )
        )
      )
...
function TableCellEditable({ item, column, isEditing, onEditStart, onEditEnd, submitEdit, ariaLabels, successfulEdit = false, ...rest }) {
  var _a, _b, _c;
  const i18n = useInternalI18n("table");
  const editActivateRef = (0, import_react14.useRef)(null);
  const tdNativeAttributes = {
    "data-inline-editing-active": isEditing.toString()
  };
  const isFocusMoveNeededRef = (0, import_react14.useRef)(false);
  const isExpandableColumn = rest.level !== void 0;
  ...
  const [hasFocus, setHasFocus] = (0, import_react14.useState)(false);
  const prevSuccessfulEdit = usePrevious(successfulEdit);
  const prevHasFocus = usePrevious(hasFocus);
  const [showSuccessIcon, setShowSuccessIcon] = (0, import_react14.useState)(false);
  (0, import_react14.useEffect)(() => {
  ...
  return import_react14.default.createElement(TableTdElement, { ...rest, nativeAttributes: tdNativeAttributes, isEditing, hasSuccessIcon: showSuccessIcon && hasFocus, onClick: !isEditing && !isExpandableColumn ? onEditStart : void 0, onFocus: () => setHasFocus(true), onBlur: () => setHasFocus(false) }, isEditing && column.editConfig ? import_react14.default.createElement(InlineEditor, { ariaLabels, column, item, onEditEnd: (options) => {
    setShowSuccessIcon(false);
    isFocusMoveNeededRef.current = options.refocusCell;
    onEditEnd(options.cancelled);
  }, submitEdit: submitEdit !== null && submitEdit !== void 0 ? submitEdit : submitHandlerFallback }) : import_react14.default.createElement(
    import_react14.default.Fragment,
    null,
    column.cell(item),
    showSuccessIcon && hasFocus && import_react14.default.createElement(
      import_react14.default.Fragment,
      null,
      import_react14.default.createElement(
        "span",
        { className: styles_css_default6["body-cell-success"], onMouseDown: (e) => {
          e.preventDefault();
        } },
        import_react14.default.createElement(internal_default, { name: "status-positive", variant: "success", ariaLabel: (_a = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.successfulEditLabel) === null || _a === void 0 ? void 0 : _a.call(ariaLabels, column) })
      ),
      import_react14.default.createElement(internal_default2, { tagName: "span", hidden: true }, i18n("ariaLabels.successfulEditLabel", (_b = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.successfulEditLabel) === null || _b === void 0 ? void 0 : _b.call(ariaLabels, column)))
    ),
    import_react14.default.createElement(
      "div",
      { className: styles_css_default6["body-cell-editor-wrapper"] },
      import_react14.default.createElement(
        "button",
        { className: clsx_m_default(styles_css_default6["body-cell-editor"], isExpandableColumn && styles_css_default6["body-cell-editor-focusable"]), "aria-label": (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.activateEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column, item), ref: editActivateRef, onClick: !isEditing && isExpandableColumn ? onEditStart : void 0, tabIndex: editActivateTabIndex },
        import_react14.default.createElement(
          "span",
          { className: styles_css_default6["body-cell-editor-icon"] },
          import_react14.default.createElement(internal_default, { name: "edit" })
        )
      )
    )
  ));
...
function TableBodyCell(props) {
  ...
  if (editDisabledReason) {
    return import_react14.default.createElement(DisabledInlineEditor, { editDisabledReason, ...props });
  }
  if (props.isEditable || props.isEditing) {
    return import_react14.default.createElement(TableCellEditable, { ...props });
  }
  const { column, item } = props;
  return import_react14.default.createElement(TableTdElement, { ...props, isEditable: false }, column.cell(item));
}
...
function useExpandableTableProps({ items, expandableRows, trackBy, ariaLabels }) {
  ...
  const getItemLevel = (item) => {
    var _a2, _b2;
    return (_b2 = (_a2 = itemToDetail.get(item)) === null || _a2 === void 0 ? void 0 : _a2.level) !== null && _b2 !== void 0 ? _b2 : 0;
  };
  if (isExpandable) {
  ...
  const getExpandableItemProps = (item) => {
    ...
    return {
      ...
      setSize,
      posInSet,
      isExpandable: (_b2 = expandableRows === null || expandableRows === void 0 ? void 0 : expandableRows.isItemExpandable(item)) !== null && _b2 !== void 0 ? _b2 : true,
...
function NoDataCell({ totalColumnsCount, hasFooter, loading, loadingText, empty, tableRef, containerRef }) {
  const cellContentRef = (0, import_react15.useRef)(null);
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement("div", { ref: cellContentRef, className: styles_css_default4["cell-merged-content"], "data-awsui-table-suppress-navigation": true }, loading ? import_react15.default.createElement(
      StatusIndicator,
      { type: "loading", className: styles_css_default4.loading, wrapText: true },
      import_react15.default.createElement(internal_default2, { tagName: "span" }, loadingText)
    ) : import_react15.default.createElement("div", { className: styles_css_default4.empty }, empty))
  );
}
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/progressive-loading/styles.scoped.css";
...
function ItemsLoader({ item, trackBy, children }) {
  ...
  return import_react16.default.createElement("div", { "data-root": item ? "false" : "true", "data-parentrow": parentTrackId, className: styles_css_default7["items-loader"] }, children);
}
function getLoaderContent({ item, loadingStatus, renderLoaderPending, renderLoaderLoading, renderLoaderError, renderLoaderEmpty }) {
  ...
  if (loadingStatus === "pending" && renderLoaderPending) {
    ...
    content = import_react16.default.createElement(internal_default2, { tagName: "span" }, renderLoaderLoading({ item }));
  } else if (loadingStatus === "error" && renderLoaderError) {
    content = import_react16.default.createElement(internal_default2, { tagName: "span" }, renderLoaderError({ item }));
  } else if (loadingStatus === "finished" && renderLoaderEmpty && item) {
    content = import_react16.default.createElement(internal_default2, { tagName: "span" }, renderLoaderEmpty({ item }));
  } else {
...
function TableLoaderCell({ item, trackBy, counter, children, ...props }) {
  return props.isRowHeader ? import_react17.default.createElement(
    TableTdElement,
    { ...props, counter, isEditable: false, isEditing: false },
    import_react17.default.createElement(ItemsLoader, { item, trackBy }, children)
  ) : import_react17.default.createElement(TableTdElement, { ...props, isEditable: false, isEditing: false }, null);
}

// node_modules/@cloudscape-design/components/table/progressive-loading/progressive-loading-utils.js
function useProgressiveLoadingProps({ getLoadingStatus, expandableRows }) {
  const allRows = new Array();
  const items = expandableRows.allItems;
  const getItemParent = (item) => expandableRows.getExpandableItemProps(item).parent;
  const getItemChildren = (item) => expandableRows.getExpandableItemProps(item).children;
  const getItemLevel = (item) => item ? expandableRows.getExpandableItemProps(item).level : 0;
  const isItemExpanded = (item) => expandableRows.getExpandableItemProps(item).isExpanded;
...
function useThrottleCallback(func, delay, deps) {
  return (0, import_react18.useMemo)(() => throttle(func, delay), deps);
}
...
var WidthsContext = (0, import_react19.createContext)({
  getColumnStyles: () => ({}),
...
function ColumnWidthsProvider({ visibleColumns, resizableColumns, containerRef, children }) {
  const visibleColumnsRef = (0, import_react19.useRef)(null);
  const containerWidthRef = (0, import_react19.useRef)(0);
  const [columnWidths, setColumnWidths] = (0, import_react19.useState)(null);
  const cellsRef = (0, import_react19.useRef)(/* @__PURE__ */ new Map());
  const stickyCellsRef = (0, import_react19.useRef)(/* @__PURE__ */ new Map());
  ...
  return import_react19.default.createElement(WidthsContext.Provider, { value: { getColumnStyles, columnWidths: columnWidths !== null && columnWidths !== void 0 ? columnWidths : /* @__PURE__ */ new Map(), updateColumn, setCell } }, children);
}
function useColumnWidths() {
  return (0, import_react19.useContext)(WidthsContext);
}

// node_modules/@cloudscape-design/components/table/resizer/styles.css.js
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/resizer/styles.scoped.css";
...
function getResizerElements(resizerElement) {
  ...
  const tracker = tableRoot.querySelector(`.${styles_css_default8.tracker}`);
  if (!tracker) {
    return null;
  }
...
// node_modules/@cloudscape-design/components/table/resizer/index.js
var RESIZE_THROTTLE = 25;
var AUTO_GROW_START_TIME = 10;
var AUTO_GROW_INTERVAL = 10;
var AUTO_GROW_INCREMENT = 5;
function Divider({ className }) {
  return import_react20.default.createElement("span", { className: clsx_m_default(styles_css_default8.divider, styles_css_default8["divider-disabled"], className) });
}
function Resizer({ onWidthUpdate, onWidthUpdateCommit, ariaLabelledby, minWidth = DEFAULT_COLUMN_WIDTH, tabIndex, showFocusRing, focusId, roleDescription, tooltipText, isBorderless }) {
  ...
  const positioningWrapperRef = (0, import_react20.useRef)(null);
  const resizerToggleRef = (0, import_react20.useRef)(null);
  const resizerSeparatorRef = (0, import_react20.useRef)(null);
  const [isPointerDown, setIsPointerDown] = (0, import_react20.useState)(false);
  const [isDragging, setIsDragging] = (0, import_react20.useState)(false);
  const [showUapButtons, setShowUapButtons] = (0, import_react20.useState)(false);
  const [resizerObscured, setResizerObscured] = (0, import_react20.useState)(false);
  const [isKeyboardDragging, setIsKeyboardDragging] = (0, import_react20.useState)(false);
  const autoGrowTimeout = (0, import_react20.useRef)();
  const [resizerHasFocus, setResizerHasFocus] = (0, import_react20.useState)(false);
  const [headerCellWidth, setHeaderCellWidth] = (0, import_react20.useState)(0);
  (0, import_react20.useEffect)(() => {
    setHeaderCellWidth(getHeaderWidth(resizerToggleRef.current));
  }, []);
  const isObscured = (0, import_react20.useCallback)(() => {
    ...
    elements.allHeaders.forEach((header) => {
      const { inlineSize: inlineSize2 } = getLogicalBoundingClientRect(header);
      if (header.style.insetInlineStart) {
        scrollPaddingInlineStart += inlineSize2;
      }
      if (header.style.insetInlineEnd) {
        scrollPaddingInlineEnd += inlineSize2;
      }
    });
    ...
    return (
      ...
      Math.ceil(relativeInsetInlineStart + inlineSize) < (isSticky ? 0 : scrollPaddingInlineStart) || // Is positioningWrapper obscured behind the right edge of scrollParent?
      Math.ceil(relativeInsetInlineEnd) < (isSticky ? 0 : scrollPaddingInlineEnd)
    );
  }, []);
  const scrollIntoViewIfNeeded = (0, import_react20.useCallback)(() => {
  ...
  const updateTrackerPosition = (0, import_react20.useCallback)((newOffset) => {
    const elements = getResizerElements(resizerToggleRef.current);
    if (!elements) {
      return;
    }
  ...
  const updateColumnWidth = (0, import_react20.useCallback)((newWidth) => {
    const elements = getResizerElements(resizerToggleRef.current);
    if (!elements) {
      return;
    }
  ...
  (0, import_react20.useEffect)(() => {
    ...
    const controller = new AbortController();
    if (isPointerDown) {
      document2.body.classList.add(styles_css_default8["resize-active"]);
      document2.addEventListener("pointermove", onPointerMove, { signal: controller.signal });
      document2.addEventListener("pointerup", onPointerUp, { signal: controller.signal });
    } else if (resizerHasFocus) {
      document2.body.classList.add(styles_css_default8["resize-active-with-focus"]);
    ...
    return () => {
      document2.body.classList.remove(styles_css_default8["resize-active"]);
      document2.body.classList.remove(styles_css_default8["resize-active-with-focus"]);
      controller.abort();
    };
  }, [
    isDragging,
  ...
  return import_react20.default.createElement(
    "div",
    {
      ...
      className: clsx_m_default(styles_css_default8["resizer-wrapper"], isVisualRefresh && styles_css_default8["visual-refresh"], (!isVisualRefresh || isBorderless) && styles_css_default8["is-borderless"]),
      ref: positioningWrapperRef
    },
    import_react20.default.createElement(
      DragHandleWrapper,
      { clickDragThreshold: 3, hideButtonsOnDrag: false, directions: {
        "inline-start": resizerObscured ? void 0 : headerCellWidth > minWidth ? "active" : "disabled",
        "inline-end": resizerObscured ? void 0 : "active"
      }, triggerMode: "controlled", controlledShowButtons: showUapButtons && !resizerObscured, wrapperClassName: styles_css_default8["resizer-button-wrapper"], tooltipText, "data-obscured": resizerObscured, onDirectionClick: (direction) => {
        const elements = getResizerElements(resizerToggleRef.current);
        if (!elements) {
          return;
        }
      ...
      import_react20.default.createElement("button", { type: "button", ref: resizerToggleRef, className: clsx_m_default(styles_css_default8.resizer, (resizerHasFocus || showFocusRing || isKeyboardDragging) && styles_css_default8["has-focus"]), onPointerDown: (event) => {
      ...
      import_react20.default.createElement("span", { className: clsx_m_default(styles_css_default8["divider-interactive"], (isPointerDown || isDragging) && styles_css_default8["divider-active"]), "data-awsui-table-suppress-navigation": true, ref: resizerSeparatorRef, id: separatorId, role: "slider", tabIndex: -1, "aria-labelledby": ariaLabelledby, "aria-hidden": !isKeyboardDragging, "aria-valuemin": minWidth, "aria-valuemax": Number.MAX_SAFE_INTEGER, "aria-valuenow": headerCellWidth, "data-focus-id": focusId, onBlur: (event) => {
        setIsKeyboardDragging(false);
...
function ResizeTracker() {
  return import_react20.default.createElement("span", { className: styles_css_default8.tracker });
}
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/checkbox/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/checkbox/internal.js
var InternalCheckbox = import_react21.default.forwardRef(({ controlId, name, checked, disabled, readOnly, ariaRequired, indeterminate, children, description, ariaLabel, onFocus, onBlur, onChange, tabIndex: explicitTabIndex, showOutline, ariaControls, style, nativeInputAttributes, __internalRootRef, __injectAnalyticsComponentMetadata = false, ...rest }, ref) => {
  const { ariaDescribedby, ariaLabelledby } = useFormFieldContext(rest);
  const baseProps = getBaseProps(rest);
  const checkboxRef = (0, import_react21.useRef)(null);
  ...
  return import_react21.default.createElement(AbstractSwitch, { ...baseProps, className: clsx_m_default(styles_css_default9.root, baseProps.className), controlClassName: styles_css_default9["checkbox-control"], outlineClassName: styles_css_default9.outline, controlId, disabled, readOnly, label: children, description, descriptionBottomPadding: true, ariaLabel, ariaLabelledby, ariaDescribedby, ariaControls, showOutline, nativeControl: (nativeControlProps) => import_react21.default.createElement(with_native_attributes_default, {
    ...nativeControlProps,
    tag: "input",
...
// node_modules/@cloudscape-design/components/table/selection/selection-control.js
function SelectionControl({ selectionType, indeterminate = false, onShiftToggle, onFocusUp, onFocusDown, name, ariaLabel, focusedComponent, rowIndex, itemKey, verticalAlign = "middle", onChange, ...sharedProps }) {
  ...
  const selector = isMultiSelection ? import_react22.default.createElement(internal_default5, { ...sharedProps, onChange, showOutline: focusedComponent === "selection-control", controlId, "data-focus-id": "selection-control", indeterminate }) : import_react22.default.createElement(radio_button_default, { ...sharedProps, controlId, name, value: "", onSelect: onChange });
  return import_react22.default.createElement(
    import_react22.default.Fragment,
    null,
    import_react22.default.createElement("label", { onKeyDown: handleKeyDown, onKeyUp: setShiftState, onMouseDown: onMouseDownHandler, onMouseUp: setShiftState, onClick: handleClick, htmlFor: controlId, className: clsx_m_default(styles_css_default10.label, styles_css_default10.root, verticalAlign === "top" && styles_css_default10["label-top"]), "aria-label": ariaLabel, title: ariaLabel, ...rowIndex !== void 0 && !sharedProps.disabled ? getAnalyticsMetadataAttribute({
      detail: {
        position: `${rowIndex + 1}`,
        item: itemKey || ""
      }
    }) : {} }, selector),
    import_react22.default.createElement("span", { className: styles_css_default10.stud, "aria-hidden": true }, " ")
  );
}
...
function findSelectionControlByIndex(rootContainer, index) {
  if (index === -1) {
    return rootContainer.querySelector(`[data-${SELECTION_ITEM}="all"] .${styles_css_default10.root} input`);
  }
  return rootContainer.querySelectorAll(`[data-${SELECTION_ITEM}="item"] .${styles_css_default10.root} input`)[index];
}
...
function useMultiSelection({ ariaLabels, isItemDisabled = () => false, items, loading, onSelectionChange, selectedItems = [], selectionType, trackBy, setLastUserAction, totalItemsCount }) {
  const selectionControlName = useUniqueId();
  const [shiftPressed, setShiftPressed] = (0, import_react23.useState)(false);
  const [lastClickedItem, setLastClickedItem] = (0, import_react23.useState)(null);
  if (selectionType !== "multi") {
    return { isItemSelected: () => false };
  }
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/header-cell/styles.scoped.css";
...
// node_modules/@cloudscape-design/components/table/header-cell/th-element.js
function TableThElement({ resizableStyle, sortingStatus, sortingDisabled, focusedComponent, stuck, sticky, resizable, hidden, stripedRows, isSelection, colIndex, columnId, stickyState, cellRef, tableRole, children, variant, ariaLabel, tableVariant, ...props }) {
  const isVisualRefresh = useVisualRefresh();
  const stickyStyles = useStickyCellStyles({
    stickyColumns: stickyState,
    columnId,
    getClassName: (props2) => getStickyClassNames(styles_css_default11, props2)
  });
  const cellRefObject = (0, import_react24.useRef)(null);
  const mergedRef = useMergeRefs(stickyStyles.ref, cellRef, cellRefObject);
  const { tabIndex: cellTabIndex } = useSingleTabStopNavigation(cellRefObject);
  return import_react24.default.createElement("th", { "data-focus-id": `header-${String(columnId)}`, className: clsx_m_default(styles_css_default11["header-cell"], styles_css_default11[`header-cell-variant-${variant}`], sticky && styles_css_default11["header-cell-sticky"], resizable && styles_css_default11["header-cell-resizable"], stuck && styles_css_default11["header-cell-stuck"], stripedRows && styles_css_default11["has-striped-rows"], isVisualRefresh && styles_css_default11["is-visual-refresh"], isSelection && clsx_m_default(styles_css_default4["selection-control"], styles_css_default4["selection-control-header"]), tableVariant && styles_css_default11[`table-variant-${tableVariant}`], {
    [styles_css_default11["header-cell-fake-focus"]]: focusedComponent === `header-${String(columnId)}`,
    [styles_css_default11["header-cell-sortable"]]: sortingStatus,
    [styles_css_default11["header-cell-sorted"]]: sortingStatus === "ascending" || sortingStatus === "descending",
    [styles_css_default11["header-cell-disabled"]]: sortingDisabled,
    [styles_css_default11["header-cell-ascending"]]: sortingStatus === "ascending",
    [styles_css_default11["header-cell-descending"]]: sortingStatus === "descending",
    [styles_css_default11["header-cell-hidden"]]: hidden
  }, stickyStyles.className), style: { ...resizableStyle, ...stickyStyles.style }, ref: mergedRef, ...getTableColHeaderRoleProps({ tableRole, sortingStatus, colIndex }), tabIndex: cellTabIndex === -1 ? void 0 : cellTabIndex, ...copyAnalyticsMetadataAttribute(props), ...ariaLabel ? { "aria-label": ariaLabel } : {} }, children);
}

// node_modules/@cloudscape-design/components/table/selection/selection-cell.js
function TableHeaderSelectionCell({ focusedComponent, singleSelectionHeaderAriaLabel, getSelectAllProps, onFocusMove, ...props }) {
  const selectAllProps = getSelectAllProps ? getSelectAllProps() : void 0;
  return import_react25.default.createElement(
    TableThElement,
    { ...props, isSelection: true, colIndex: 0, focusedComponent, ariaLabel: selectAllProps === null || selectAllProps === void 0 ? void 0 : selectAllProps.selectionGroupLabel, ...getAnalyticsMetadataAttribute({
      action: (selectAllProps === null || selectAllProps === void 0 ? void 0 : selectAllProps.checked) ? "deselectAll" : "selectAll"
    }) },
    selectAllProps ? import_react25.default.createElement(SelectionControl, { onFocusDown: (event) => {
      onFocusMove(event.target, -1, 1);
    }, focusedComponent, ...selectAllProps, ...props.sticky ? { tabIndex: -1 } : {} }) : import_react25.default.createElement(ScreenreaderOnly, null, singleSelectionHeaderAriaLabel),
    import_react25.default.createElement(Divider, { className: styles_css_default4["resize-divider"] })
  );
}
function TableBodySelectionCell({ selectionControlProps, ...props }) {
  return import_react25.default.createElement(TableTdElement, { ...props, isSelection: true, wrapLines: false, isEditable: false, isEditing: false, colIndex: 0 }, selectionControlProps ? import_react25.default.createElement(SelectionControl, { ...selectionControlProps, verticalAlign: props.verticalAlign }) : null);
}

// node_modules/@cloudscape-design/components/table/selection/use-group-selection.js
var import_react26 = __toESM(require_react());
function useGroupSelection({ ariaLabels, items, rootItems, selectedItems = [], totalItemsCount, trackBy, expandableRows, selectionType, getLoadingStatus, setLastUserAction }) {
  const selectionControlName = useUniqueId();
  const [shiftPressed, setShiftPressed] = (0, import_react26.useState)(false);
  const [lastClickedItem, setLastClickedItem] = (0, import_react26.useState)(null);
  ...
  const handleToggleItem = (item) => {
    setLastClickedItem(item);
    const requestedItems = shiftPressed ? getShiftSelectedItems(item) : [item];
    const requestedItemParents = requestedItems.reduce((set, item2) => set.add(getParent(item2)), /* @__PURE__ */ new Set());
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/analytics-metadata/styles.scoped.css";
...
function TableHeaderCell({ tabIndex, column, activeSortingColumn, sortingDescending, sortingDisabled, wrapLines, focusedComponent, stuck, sticky, hidden, stripedRows, onClick, colIndex, updateColumn, resizableColumns, resizableStyle, onResizeFinish, isEditable, columnId, stickyState, cellRef, tableRole, resizerRoleDescription, resizerTooltipText, isExpandable, hasDynamicContent, variant, tableVariant }) {
  ...
  const clickableHeaderRef = (0, import_react27.useRef)(null);
  const { tabIndex: clickableHeaderTabIndex } = useSingleTabStopNavigation(clickableHeaderRef, { tabIndex });
  const cellRefObject = (0, import_react27.useRef)(null);
  ...
  return import_react27.default.createElement(
    TableThElement,
    { resizableStyle, cellRef: cellRefCombined, sortingStatus, sortingDisabled, focusedComponent, stuck, sticky, resizable: resizableColumns, hidden, stripedRows, colIndex, columnId, stickyState, tableRole, variant, tableVariant, ...sortingDisabled ? {} : getAnalyticsMetadataAttribute({
      action: "sort",
      detail: {
        position: `${colIndex + 1}`,
        columnId: column.id ? `${column.id}` : "",
        label: `.${styles_css_default12["header-cell-text"]}`,
        sortingDescending: `${!sortingDescending}`
      }
    }) },
    import_react27.default.createElement(
      "div",
      { ref: clickableHeaderRef, "data-focus-id": `sorting-control-${String(columnId)}`, className: clsx_m_default(styles_css_default11["header-cell-content"], {
        [styles_css_default11["header-cell-fake-focus"]]: focusedComponent === `sorting-control-${String(columnId)}`,
        [styles_css_default11["header-cell-content-expandable"]]: isExpandable
      ...
      import_react27.default.createElement(
        "div",
        { className: clsx_m_default(styles_css_default11["header-cell-text"], styles_css_default12["header-cell-text"], wrapLines && styles_css_default11["header-cell-text-wrap"]), id: headerId },
        column.header,
        isEditable ? import_react27.default.createElement(
          "span",
          { className: styles_css_default11["edit-icon"] },
          import_react27.default.createElement(internal_default, { name: "edit", ariaLabel: i18n("columnDefinitions.editConfig.editIconAriaLabel", (_a = column.editConfig) === null || _a === void 0 ? void 0 : _a.editIconAriaLabel) })
        ) : null
      ),
      sortingStatus && import_react27.default.createElement(
        "span",
        { className: styles_css_default11["sorting-icon"] },
        import_react27.default.createElement(internal_default, { name: getSortingIconName(sortingStatus) })
      )
    ),
    resizableColumns ? import_react27.default.createElement(Resizer, {
      tabIndex,
    ...
    }) : import_react27.default.createElement(Divider, { className: styles_css_default11["resize-divider"] })
  );
}

// node_modules/@cloudscape-design/components/table/thead.js
var Thead = import_react28.default.forwardRef(({ selectionType, getSelectAllProps, columnDefinitions, sortingColumn, sortingDisabled, sortingDescending, resizableColumns, variant, tableVariant, wrapLines, onFocusMove, onSortingChange, onResizeFinish, singleSelectionHeaderAriaLabel, stripedRows, sticky = false, hidden = false, stuck = false, stickyState, selectionColumnId: selectionColumnId2, focusedComponent, onFocusedComponentChange, tableRole, resizerRoleDescription, resizerTooltipText, isExpandable, setLastUserAction }, outerRef) => {
  ...
  return import_react28.default.createElement(
    ...
    import_react28.default.createElement(
      "tr",
      { ...focusMarkers.all, ref: outerRef, "aria-rowindex": 1, ...getTableHeaderRowRoleProps({ tableRole }), onFocus: (event) => {
        var _a;
      ...
      selectionType ? import_react28.default.createElement(TableHeaderSelectionCell, { ...commonCellProps, focusedComponent, columnId: selectionColumnId2, getSelectAllProps, onFocusMove, singleSelectionHeaderAriaLabel }) : null,
      columnDefinitions.map((column, colIndex) => {
        const columnId = getColumnKey(column, colIndex);
        return import_react28.default.createElement(TableHeaderCell, {
          ...commonCellProps,
          key: columnId,
          tabIndex: sticky ? -1 : 0,
          focusedComponent,
...
var useStickyHeader = (tableRef, theadRef, secondaryTheadRef, secondaryTableRef, tableWrapperRef) => {
  ...
  const syncColumnHeaderWidths = (0, import_react29.useCallback)(() => {
...
// node_modules/@cloudscape-design/components/table/sticky-header.js
var sticky_header_default = (0, import_react30.forwardRef)(StickyHeader);
function StickyHeader({ variant, theadProps, wrapperRef, theadRef, secondaryWrapperRef, onScroll, tableRef, tableHasHeader, contentDensity, tableRole }, ref) {
  const secondaryTheadRef = (0, import_react30.useRef)(null);
  const secondaryTableRef = (0, import_react30.useRef)(null);
  const { isStuck } = (0, import_react30.useContext)(StickyHeaderContext);
  const [focusedComponent, setFocusedComponent] = (0, import_react30.useState)(null);
  ...
  return import_react30.default.createElement(
    ...
    import_react30.default.createElement(
      "table",
      { className: clsx_m_default(styles_css_default4.table, styles_css_default4["table-layout-fixed"], contentDensity === "compact" && getVisualContextClassname("compact-table")), ref: secondaryTableRef, ...getTableRoleProps({ tableRole }) },
      import_react30.default.createElement(thead_default, { ref: secondaryTheadRef, sticky: true, stuck: isStuck, focusedComponent, ...theadProps })
    )
  );
}
...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/table/sticky-scrollbar/styles.scoped.css";
...
var updatePosition = (tableEl, wrapperEl, scrollbarEl, scrollbarContentEl, inScrollableContainer) => {
  ...
  if (!areaIsScrollable) {
    scrollbarEl.classList.remove(styles_css_default13["sticky-scrollbar-visible"]);
  } else {
    if (!scrollbarEl.classList.contains(styles_css_default13["sticky-scrollbar-visible"])) {
      requestAnimationFrame(() => {
        scrollbarEl.scrollLeft = wrapperEl.scrollLeft;
      });
    }
    scrollbarEl.classList.add(styles_css_default13["sticky-scrollbar-visible"]);
    if (!scrollbarHeight) {
      scrollbarEl.classList.add(styles_css_default13["sticky-scrollbar-native-invisible"]);
    }
  }
...
function useStickyScrollbar(scrollbarRef, scrollbarContentRef, tableRef, wrapperRef, offsetScrollbar) {
  const [inScrollableContainer, setInScrollableContainer] = (0, import_react31.useState)(false);
...
// node_modules/@cloudscape-design/components/table/sticky-scrollbar/sticky-scrollbar.js
var sticky_scrollbar_default = (0, import_react32.forwardRef)(StickyScrollbar);
function StickyScrollbar({ wrapperRef, tableRef, onScroll, hasStickyColumns }, ref) {
  const isVisualRefresh = useVisualRefresh();
  const scrollbarRef = import_react32.default.useRef(null);
  const scrollbarContentRef = import_react32.default.useRef(null);
  ...
  return import_react32.default.createElement(
    ...
    import_react32.default.createElement(
      "div",
      { ref: mergedRef, className: clsx_m_default(styles_css_default13["sticky-scrollbar"], offsetScrollbar && styles_css_default13["sticky-scrollbar-offset"], isVisualRefresh && styles_css_default13["is-visual-refresh"]), onScroll, "data-stuck": !isStickyDetectionVisible },
      import_react32.default.createElement("div", { ref: scrollbarContentRef, className: styles_css_default13["sticky-scrollbar-content"] })
    ),
    import_react32.default.createElement("div", { ref: stickyDetectionRef, style: { position: "absolute", right: 0, bottom: 0, left: 0, height: 1 } })
  );
}
...
function ToolsHeader({ header, filter, pagination, preferences, setLastUserAction }) {
  ...
  const assignHeaderId = (0, import_react33.useContext)(CollectionLabelContext).assignId;
  ...
  return import_react33.default.createElement(
    ...
    null,
    isHeaderString ? import_react33.default.createElement("span", { id: headingId }, header) : header,
    hasTools && import_react33.default.createElement(
      "div",
      { ref, className: clsx_m_default(styles_css_default4.tools, isSmall && styles_css_default4["tools-small"]) },
      filter && import_react33.default.createElement("div", { className: styles_css_default4["tools-filtering"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter"), onKeyDownCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter") }, filter),
      import_react33.default.createElement(
        "div",
        { className: styles_css_default4["tools-align-right"] },
        pagination && import_react33.default.createElement("div", { className: styles_css_default4["tools-pagination"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("pagination") }, pagination),
        preferences && import_react33.default.createElement("div", { className: styles_css_default4["tools-preferences"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("preferences") }, preferences)
      )
    )
  );
}
...
function useCellEditing({ onCancel, onSubmit }) {
  const [currentEditCell, setCurrentEditCell] = (0, import_react34.useState)(null);
  const [lastSuccessfulEditCell, setLastSuccessfulEditCell] = (0, import_react34.useState)(null);
  const [currentEditLoading, setCurrentEditLoading] = (0, import_react34.useState)(false);
  const startEdit = (cellId) => {
    setLastSuccessfulEditCell(null);
    setCurrentEditCell(cellId);
  };
  const cancelEdit = (0, import_react34.useCallback)(() => setCurrentEditCell(null), []);
  ...
  const submitEdit = onSubmit ? async (...args) => {
    setCurrentEditLoading(true);
    try {
      await onSubmit(...args);
    } finally {
...
var stickyCellSelector = `.${styles_css_default6["sticky-cell"]}`;
...
function useTableFocusNavigation({ enableKeyboardNavigation, selectionType, tableRoot, columnDefinitions, numRows }) {
  const focusableColumns = (0, import_react36.useMemo)(() => {
  ...
  const focusCell = (0, import_react36.useCallback)((rowIndex, columnIndex) => {
  ...
  const shiftFocus = (0, import_react36.useCallback)((vertical, horizontal) => {
    var _a;
  ...
  const handleArrowKeyEvents = (0, import_react36.useCallback)((event) => {
    var _a, _b;
...
var InternalTableAsSubstep = import_react37.default.forwardRef((props, ref) => {
  const { funnelSubStepProps } = useFunnelSubStep();
  const tableProps = {
    ...props,
    __funnelSubStepProps: funnelSubStepProps
  };
  return import_react37.default.createElement(InternalTable, { ...tableProps, ref });
});
var InternalTable = import_react37.default.forwardRef(({ header, footer, empty, filter, pagination, preferences, items, columnDefinitions, trackBy, loading, loadingText, selectionType: externalSelectionType, selectedItems, isItemDisabled, ariaLabels, onSelectionChange, onSortingChange, sortingColumn, sortingDescending, sortingDisabled, visibleColumns, stickyHeader, stickyHeaderVerticalOffset, onRowClick, onRowContextMenu, wrapLines, stripedRows, contentDensity, submitEdit, onEditCancel, resizableColumns, onColumnWidthsChange, variant, __internalRootRef, totalItemsCount, firstIndex, renderAriaLive, stickyColumns, columnDisplay, enableKeyboardNavigation, expandableRows: externalExpandableRows, getLoadingStatus, renderLoaderPending, renderLoaderLoading, renderLoaderError, renderLoaderEmpty, renderLoaderCounter, cellVerticalAlign, __funnelSubStepProps, ...rest }, ref) => {
  var _a, _b, _c;
  if (externalExpandableRows && enableKeyboardNavigation === void 0) {
  ...
  const wrapperMeasureRefObject = (0, import_react37.useRef)(null);
  ...
  const tableRefObject = (0, import_react37.useRef)(null);
  const secondaryWrapperRef = import_react37.default.useRef(null);
  const theadRef = (0, import_react37.useRef)(null);
  const stickyHeaderRef = import_react37.default.useRef(null);
  const scrollbarRef = import_react37.default.useRef(null);
  const { cancelEdit, ...cellEditing } = useCellEditing({ onCancel: onEditCancel, onSubmit: submitEdit });
  const paginationRef = (0, import_react37.useRef)({});
  const filterRef = (0, import_react37.useRef)({});
  const preferencesRef = (0, import_react37.useRef)({});
  const headerRef = (0, import_react37.useRef)({});
  const getHeaderText = () => {
    var _a2, _b2, _c2, _d;
    return (_c2 = (_b2 = (_a2 = toolsHeaderPerformanceMarkRef.current) === null || _a2 === void 0 ? void 0 : _a2.querySelector(`.${styles_css_default2["heading-text"]}`)) === null || _b2 === void 0 ? void 0 : _b2.innerText) !== null && _c2 !== void 0 ? _c2 : (_d = toolsHeaderPerformanceMarkRef.current) === null || _d === void 0 ? void 0 : _d.innerText;
  };
  ...
  const wrapperRefObject = (0, import_react37.useRef)(null);
  ...
  const headerIdRef = (0, import_react37.useRef)(void 0);
  ...
  const setHeaderRef = (0, import_react37.useCallback)((id) => {
  ...
  const toolsHeaderPerformanceMarkRef = (0, import_react37.useRef)(null);
  ...
  return import_react37.default.createElement(
    ...
    import_react37.default.createElement(
      ...
      import_react37.default.createElement(
        ...
        import_react37.default.createElement(
          InternalContainer,
          { ...baseProps, ...tableInteractionAttributes, __internalRootRef, className: clsx_m_default(baseProps.className, styles_css_default4.root), __funnelSubStepProps, __fullPage: variant === "full-page", header: import_react37.default.createElement(
            import_react37.default.Fragment,
            null,
            hasHeader && import_react37.default.createElement(
              "div",
              null,
              import_react37.default.createElement(
                "div",
                ...
                import_react37.default.createElement(
                  ...
                  import_react37.default.createElement(ToolsHeader, { header, filter, pagination, preferences, setLastUserAction })
                )
              )
            ),
            stickyHeader && import_react37.default.createElement(sticky_header_default, { ref: stickyHeaderRef, variant: computedVariant, theadProps, wrapperRef: wrapperRefObject, theadRef, secondaryWrapperRef, tableRef: tableRefObject, onScroll: handleScroll, tableHasHeader: hasHeader, contentDensity, tableRole })
          ), disableHeaderPaddings: true, disableContentPaddings: true, disableFooterPaddings: true, variant: toContainerVariant(computedVariant), __disableFooterDivider: true, __disableStickyMobile: false, footer: hasFooter ? import_react37.default.createElement(
            "div",
            ...
            import_react37.default.createElement(
              ...
              footer && import_react37.default.createElement("span", null, footer),
              hasFooterPagination && import_react37.default.createElement("div", { className: styles_css_default4["footer-pagination"] }, pagination)
            )
          ...
          import_react37.default.createElement(
            "div",
            { ref: wrapperRef, className: clsx_m_default(styles_css_default4.wrapper, styles_css_default4[`variant-${computedVariant}`], {
            ...
            import_react37.default.createElement("div", { className: styles_css_default4["wrapper-content-measure"], ref: wrapperMeasureMergedRef }),
            !!renderAriaLive && !!firstIndex && !loading && import_react37.default.createElement(
              internal_default2,
              { hidden: true, tagName: "span" },
              import_react37.default.createElement("span", null, renderAriaLive({
                firstIndex,
            ...
            import_react37.default.createElement(
              ...
              import_react37.default.createElement(
                "table",
                { ...performanceMarkAttributes, ref: tableRef, className: clsx_m_default(styles_css_default4.table, resizableColumns && styles_css_default4["table-layout-fixed"], contentDensity === "compact" && getVisualContextClassname("compact-table")), ...getTableRoleProps({
                  tableRole,
                  totalItemsCount,
                  totalColumnsCount,
                  ariaLabel: ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.tableLabel,
                ...
                import_react37.default.createElement(thead_default, { ref: theadRef, hidden: stickyHeader, onFocusedComponentChange: (focusId) => {
                  var _a2;
                  return (_a2 = stickyHeaderRef.current) === null || _a2 === void 0 ? void 0 : _a2.setFocus(focusId);
                }, ...theadProps }),
                import_react37.default.createElement("tbody", null, loading || allItems.length === 0 ? import_react37.default.createElement(
                  "tr",
                  null,
                  import_react37.default.createElement(NoDataCell, { totalColumnsCount, hasFooter, loading, loadingText, empty, tableRef: tableRefObject, containerRef: wrapperMeasureRefObject })
                ) : allRows.map((row, rowIndex) => {
                  const isFirstRow = rowIndex === 0;
                  const isLastRow = rowIndex === allRows.length - 1;
                  const rowExpandableProps = row.type === "data" ? expandableRows.getExpandableItemProps(row.item) : void 0;
                  ...
                  if (row.type === "data") {
                    ...
                    return import_react37.default.createElement(
                      "tr",
                      { key: rowId, className: clsx_m_default(styles_css_default4.row, sharedCellProps.isSelected && styles_css_default4["row-selected"]), onFocus: ({ currentTarget }) => {
                        var _a2;
                      ...
                      selection.getItemSelectionProps && import_react37.default.createElement(TableBodySelectionCell, { ...sharedCellProps, columnId: selectionColumnId, selectionControlProps: {
                      ...
                      visibleColumnDefinitions.map((column, colIndex) => {
                        ...
                        const cellExpandableProps = isExpandable && colIndex === 0 ? rowExpandableProps : void 0;
                        const counter = (_a2 = column.counter) === null || _a2 === void 0 ? void 0 : _a2.call(column, {
                          item: row.item,
                        ...
                        return import_react37.default.createElement(TableBodyCell, { key: colId, ...sharedCellProps, resizableStyle: {
                          width: column.width,
                          minWidth: column.minWidth,
                          maxWidth: column.maxWidth
                        }, ariaLabels, column, item: row.item, wrapLines, isEditable, isEditing, isRowHeader: column.isRowHeader, successfulEdit, resizableColumns, onEditStart: () => cellEditing.startEdit(cellId), onEditEnd: (editCancelled) => cellEditing.completeEdit(cellId, editCancelled), submitEdit: cellEditing.submitEdit, columnId: (_b2 = column.id) !== null && _b2 !== void 0 ? _b2 : colIndex, colIndex: colIndex + colIndexOffset, verticalAlign: (_c2 = column.verticalAlign) !== null && _c2 !== void 0 ? _c2 : cellVerticalAlign, tableVariant: computedVariant, counter, ...cellExpandableProps, ...getAnalyticsMetadataAttribute(analyticsMetadata2) });
                      })
                    );
                  }
                  const loaderSelectionProps = selection.getLoaderSelectionProps && selection.getLoaderSelectionProps(row.item);
                  const rowSelection = selectionType === "group" ? loaderSelectionProps : void 0;
                  ...
                  return loaderContent && import_react37.default.createElement(
                    "tr",
                    { key: (row.item ? getTableItemKey(row.item) : "root-" + rowIndex) + "-" + row.from, className: styles_css_default4.row, ...rowRoleProps },
                    selectionType ? import_react37.default.createElement(TableBodySelectionCell, { ...sharedCellProps, columnId: selectionColumnId, verticalAlign: cellVerticalAlign, tableVariant: computedVariant, selectionControlProps: selectionType === "group" ? loaderSelectionProps : void 0, isSelected: selectionType === "group" && !!(loaderSelectionProps === null || loaderSelectionProps === void 0 ? void 0 : loaderSelectionProps.checked) }) : null,
                    visibleColumnDefinitions.map((column, colIndex) => {
                      var _a2;
                      return import_react37.default.createElement(TableLoaderCell, { key: getColumnKey(column, colIndex), ...sharedCellProps, wrapLines: false, columnId: (_a2 = column.id) !== null && _a2 !== void 0 ? _a2 : colIndex, colIndex: colIndex + colIndexOffset, isSelected: selectionType === "group" && !!(loaderSelectionProps === null || loaderSelectionProps === void 0 ? void 0 : loaderSelectionProps.checked), isRowHeader: colIndex === 0, level: row.level, item: row.item, trackBy, counter: loaderCounter }, loaderContent);
                    })
                  );
                }))
              )
            ),
            resizableColumns && import_react37.default.createElement(ResizeTracker, null)
          ),
          import_react37.default.createElement(sticky_scrollbar_default, { ref: scrollbarRef, wrapperRef: wrapperRefObject, tableRef: tableRefObject, onScroll: handleScroll, hasStickyColumns })
        )
      )
    )
  );
});
var internal_default6 = InternalTable;

// node_modules/@cloudscape-design/components/table/index.js
var Table = import_react38.default.forwardRef(({ items = [], selectedItems = [], variant = "container", contentDensity = "comfortable", cellVerticalAlign = "middle", firstIndex = 1, ...props }, ref) => {
  var _a, _b, _c, _d;
  const analyticsMetadata = getAnalyticsMetadataProps(props);
  const hasHiddenColumns = props.visibleColumns && props.visibleColumns.length < props.columnDefinitions.length || ((_a = props.columnDisplay) === null || _a === void 0 ? void 0 : _a.some((col) => !col.visible));
  const hasStickyColumns = !!((_b = props.stickyColumns) === null || _b === void 0 ? void 0 : _b.first) || !!((_c = props.stickyColumns) === null || _c === void 0 ? void 0 : _c.last);
  ...
  if (variant === "borderless" || variant === "embedded") {
    return import_react38.default.createElement(
      ...
      import_react38.default.createElement(internal_default6, { ...tableProps })
    );
  }
  return import_react38.default.createElement(
    CollectionPreferencesMetadata.Provider,
    ...
    import_react38.default.createElement(
      AnalyticsFunnelSubStep,
      null,
      import_react38.default.createElement(InternalTableAsSubstep, { ...tableProps })
    )
  );
});

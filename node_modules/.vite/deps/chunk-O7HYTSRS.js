...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/input/styles.scoped.css";
var styles_css_default = {
  "root": "awsui_root_2rhyz_7dgqt_145",
  "input": "awsui_input_2rhyz_7dgqt_149",
  "input-readonly": "awsui_input-readonly_2rhyz_7dgqt_203",
  "input-invalid": "awsui_input-invalid_2rhyz_7dgqt_266",
  "input-has-icon-left": "awsui_input-has-icon-left_2rhyz_7dgqt_275",
  "input-warning": "awsui_input-warning_2rhyz_7dgqt_278",
  "input-type-search": "awsui_input-type-search_2rhyz_7dgqt_290",
  "input-has-icon-right": "awsui_input-has-icon-right_2rhyz_7dgqt_303",
  "input-has-no-border-radius": "awsui_input-has-no-border-radius_2rhyz_7dgqt_306",
  "input-container": "awsui_input-container_2rhyz_7dgqt_313",
  "input-icon-left": "awsui_input-icon-left_2rhyz_7dgqt_318",
  "input-icon-right": "awsui_input-icon-right_2rhyz_7dgqt_325",
  "input-button-right": "awsui_input-button-right_2rhyz_7dgqt_331"
};
...
function InternalInput({ type = "text", step, inputMode, autoComplete = true, ariaLabel, clearAriaLabel: clearAriaLabelOverride, name, value, placeholder, autoFocus, disabled, readOnly, disableBrowserAutocorrect, spellcheck, __noBorderRadius, __leftIcon, __leftIconVariant = "subtle", __onLeftIconClick, ariaRequired, __rightIcon, __onRightIconClick, onKeyDown, onKeyUp, onChange, __onDelayedInput, __onBlurWithDetail, onBlur, onFocus, nativeInputAttributes, __internalRootRef, __inheritFormFieldProps, __injectAnalyticsComponentMetadata, __skipNativeAttributesWarnings, style, ...rest }, ref) {
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(with_native_attributes_default, { ...attributes, tag: "input", componentName: "Input", nativeAttributes: nativeInputAttributes, skipWarnings: __skipNativeAttributesWarnings, ref: mergedRef, style: getInputStyles(style) }),
...
//# sourceMappingURL=chunk-O7HYTSRS.js.map

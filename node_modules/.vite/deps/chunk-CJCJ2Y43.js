...
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/form-field/analytics-metadata/styles.scoped.css";
var styles_css_default = {
  "label": "awsui_label_aqu00_ocied_5"
};

// node_modules/@cloudscape-design/components/form-field/styles.css.js
import "/Users/hbaisani/Hub Explorations/node_modules/@cloudscape-design/components/form-field/styles.scoped.css";
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(internal_default, { name: "status-negative", size: "small", ariaLabel: i18nErrorIconAriaLabel })
        )
      ),
      import_react.default.createElement("span", { className: styles_css_default2.error__message, ref: contentRef }, children)
    ),
    import_react.default.createElement(internal_default2, { assertive: true, tagName: "span", sources: [i18nErrorIconAriaLabel, contentRef] })
  );
}
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(internal_default, { name: "status-warning", size: "small", ariaLabel: i18nWarningIconAriaLabel })
        )
      ),
      import_react.default.createElement("span", { className: styles_css_default2.warning__message, ref: contentRef }, children)
    ),
    import_react.default.createElement(internal_default2, { assertive: true, tagName: "span", sources: [i18nWarningIconAriaLabel, contentRef] })
  );
}
...
function InternalFormField({ controlId, stretch = false, label, info, i18nStrings, children, secondaryControl, description, constraintText, errorText, warningText, __hideLabel, __internalRootRef, __disableGutters = false, __analyticsMetadata = void 0, __style = {}, ...rest }) {
  ...
  return import_react.default.createElement(
    "div",
    { ...baseProps, className: clsx_m_default(baseProps.className, styles_css_default2.root), style: __style, ref, ...analyticsAttributes, ...copyAnalyticsMetadataAttribute(rest) },
    import_react.default.createElement(
      "div",
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(FormFieldContext.Provider, { value: {
          controlId: generatedControlId,
          ...contextValuesWithoutControlId
        } }, children && import_react.default.createElement("div", { className: styles_css_default2.control }, children)),
...
//# sourceMappingURL=chunk-CJCJ2Y43.js.map
